...
async def get_pack_rarity_configs(
    ...
    """Get pack rarity configs with filtering, sorting and pagination. Uses joinedload to avoid N+1."""
    ...
    # Build response (related data loaded via joinedload)
    response_items = []
...
async def get_pack_rarity_config(
    ...
    """Get pack rarity config by ID with related data."""
...
async def get_card_weights(
    ...
    """Get card weights with filtering, sorting and pagination. Uses joinedload to avoid N+1."""
...
async def get_card_weight(
    ...
    """Get card weight by ID with related data."""
...
async def get_pack_configs_stats(
    ...
    """Get pack config statistics."""
    
    try:
        # PackRarityConfig count
