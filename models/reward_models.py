...
class UserReward(Base):
    """
    Individual rewards earned by users.
    """
    ...
    tournament_result = relationship("TournamentResult")
    
    def __repr__(self):
        return f"<UserReward(id={self.id}, user_id={self.user_id}, amount={self.amount}, status='{self.claim_status}')>"
